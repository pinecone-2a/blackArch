    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex flex-col md:flex-row p-4 2xl:mx-20 xl:mx-0 lg:mx-0 md:mx-0 sm:mx-0">
        ...
        { allProducts.map((product: any) => (
          ...
          <div key={product.id} className="group bg-white w-[300px] h-[250px] rounded-xl border shadow-md p-3 flex flex-col items-center relative overflow-hidden transition-all duration-300 ease-in-out hover:h-[300px]">
            <img src={product.image} width={150} height={150} alt="T-shirt" />
            <p className="mt-5 text-center font-semibold text-gray-800">
            {product.name}
            </p>
            <div className="my-1 text-lg font-bold text-gray-700">{product.price}</div>
