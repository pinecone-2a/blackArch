    ...
    return (
        ...
        <p className="text-2xl font-bold items-center flex ml-8 ">PINESHOP</p>
            <div className="flex gap-5 items-center my-4 mr-4 justify-end">
                ...
                <Sheet>
  <SheetTrigger> <Bell className="w-8 h-8 cursor-pointer" /></SheetTrigger>
  <SheetContent>
    <SheetHeader>
      <SheetTitle>Notifications</SheetTitle>
      <SheetDescription className="h-[1px] w-[90%] bg-gray-500 mx-auto my-5">
      </SheetDescription>
    </SheetHeader>
    <div> item Notifications </div>
                ...
                <DropdownMenu>
                    ...
                    >
                        <DropdownMenuLabel className="text-lg font-bold w-[80%] mx-auto">ADMIN</DropdownMenuLabel>
                        <DropdownMenuItem className="text-lg flex mx-auto justify-between w-[80%]" >Change Password <ChevronRight/></DropdownMenuItem>
                        <DropdownMenuItem className="text-lg flex mx-auto justify-between w-[80%]" >Log out <LogOut/></DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
            </div>
