...
import Reveal from "@/app/_components/Reavel";
        ...
        <div className="mt-20 pt-8">
          <Breadcrumb>
            <BreadcrumbList className="text-2xl flex text-gray-300 items-center">
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink className="hover:underline" href="/category">
                  Shop
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
          ...
          <div>
            {isLoading ? (
              ...
              <>
                <Reveal className="text-5xl font-bold">{product?.name}</Reveal>
                <div className="flex items-center mt-2 text-3xl">
                  <Reveal className="text-yellow-500">★★★★☆</Reveal>
                  <Reveal className="ml-2 text-gray-500 text-sm">4.5/5</Reveal>
                </div>
                <div className="flex items-center gap-2 mt-3 text-4xl">
                  <Reveal className="font-bold">{product?.price}₮</Reveal>
                </div>
                <Reveal className="mt-3 text-gray-700 text-xl">
                  {product?.description}
                </Reveal>

                <Reveal className="text-lg font-bold mt-18">
                  Select Colors
                </Reveal>

                <Reveal className="flex gap-2 mt-2 ">
                  {[
                    {
                      color: "green",
                ...
                <Reveal className="text-lg font-bold mt-18">Choose Size</Reveal>

                <Reveal className="flex gap-5 mt-2">
